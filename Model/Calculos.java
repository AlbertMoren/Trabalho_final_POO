...
public class Calculos {
    ...
    *@return Valor da posição desejada do array
    */
    ...
    */
     ...
     *
     *@param tabela uma instancia da classe Tabela.java
    ...
    public void executarCalculos(int colunaDesejada) {
        ...
        for (int i = 0; i < dados.length; i++) {
            String valor = dados[i][colunaDesejada];
            valores.add(valor);
        }
    ...
    private static List<Object> converterValores(List<String> valores) {
        ...
        if (contemFloats && !contemInteiros) {
            ...
            return new ArrayList<Object>(floats);
            ...
            return new ArrayList<Object>(inteiros);
        } else {
    ...
    private void analyzeFloatData(List<Float> numericData) {
        ...
        this.eixo_Y = drawHistogram(frequencies, min, max, k, h);
        this.eixo_X = intervals(frequencies, min, max, k, h);
     ...
     * @param min O valor mínimo da coluna
     * @param max O valor máximo da coluna
     * @param k Um int
     * @param h Um float
     * @return Um vetor do tipo inteiro
     */
    private static int[] drawHistogram(Map<?, Integer> frequencies, float min, float max, int k, float h) {
    ...
    /**
     * Recebe um mapa de frequências, um valor mínimo, um valor 
     * máximo, o número de intervalos desejado e o tamanho do 
     * intervalo. Ele cria intervalos com base nos valores e 
     * frequências fornecidos
     *
     * @param frequencies map do tipo inteiro
     * @param min Um float
     * @param max um float
     * @param k um int
     * @param h um float
     * @return Um Array do tipo String
     *
     */
    private static List<String> intervals(Map<?, Integer> frequencies, float min, float max, int k, float h) {
        List<String> intervals = new ArrayList<>();
        float lowerBound = min;
        float upperBound = lowerBound + h;
     ...
     *
     * @param frequencies Um map do tipo inteiro
     * @param lowerBound Um valor do tipo flaot
     * @param upperBound Um valor do tipo float
     ...
     *
     * @param  numericData uma lista do tipo float
     * @param media um valor do tipo float
     ...
     *
     * @param  numericData uma lista do tipo String
     * @param media um valor do tipo float
     ...
     *
     * @param frequencies, uma lista do tipo string
     * @param maxFrequency, um valor do tipo inteiro
     * @return uma lista do tipo float
     */
     ...
     *
     * @param stringData Uma lista de String
